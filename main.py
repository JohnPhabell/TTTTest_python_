...
from div_issues.issue387 import \
    run387  # Support __module__ and __qualname__ for introspection (only __module__ done and
...
def run(autoTester):
    ...
    autoTester.check(A.TypeError,
                     A.js_TypeError)  # ... Generated code should use py_TypeError and TypeError respectively
    autoTester.check('Still alive')
